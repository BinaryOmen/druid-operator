...
func (in *DruidSpec) DeepCopyInto(out *DruidSpec) {
	*out = *in
	in.Historicals.DeepCopyInto(&out.Historicals)
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *Historicals) DeepCopyInto(out *Historicals) {
	*out = *in
	in.CommonNode.DeepCopyInto(&out.CommonNode)
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Historicals.
func (in *Historicals) DeepCopy() *Historicals {
	if in == nil {
		return nil
	}
	out := new(Historicals)
