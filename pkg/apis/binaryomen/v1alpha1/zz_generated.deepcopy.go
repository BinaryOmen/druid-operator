...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DruidIngress) DeepCopyInto(out *DruidIngress) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DruidIngress.
func (in *DruidIngress) DeepCopy() *DruidIngress {
	if in == nil {
		return nil
	}
	out := new(DruidIngress)
	in.DeepCopyInto(out)
	return out
}
